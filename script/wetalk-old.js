...
[Script]
# 抓包（拦截请求，保存账号信息）
http-request ^https:\/\/api\.wetalkapp\.com\/app\/queryBalanceAndBonus script-path=https://raw.githubusercontent.com/ZenmoFeiShi/Qx/refs/heads/main/WeTalk_Shadowrocket.js, requires-body=false, tag=WeTalk抓包

# 定时任务（每天 08:20 和 20:20 执行）
cron "20 8,20 * * *" script-path=https://raw.githubusercontent.com/ZenmoFeiShi/Qx/refs/heads/main/WeTalk_Shadowrocket.js, tag=WeTalk签到
...
// ─── 核心逻辑（与原版相同，仅 fetchApi 改用 httpGet） ───────────────────────
